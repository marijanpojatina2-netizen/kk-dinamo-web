...
export default async function PrivacyPolicyPage() {
  ...
  try {
    const [globalConfig, content] = await Promise.all([
      ...
      client.fetch(legalPageQuery, { id: 'privacyPolicy' }).catch(() => null)
    ]);
    ...
    <div className="font-sans text-[#001035] bg-white w-full overflow-x-hidden selection:bg-[#002060] selection:text-white pt-24">
      ...
      <section className="relative py-20 bg-[#001035] text-white">
          <div className="max-w-[1400px] mx-auto px-4 lg:px-12">
              <h1 className="font-condensed font-bold text-5xl md:text-7xl uppercase leading-none mb-6">
      ...
      <section className="max-w-[1000px] mx-auto px-4 lg:px-12 py-20 min-h-[50vh]">
          {pageContent ? (
             ...
             <div className="text-gray-500">
                 <p>Sadržaj politike privatnosti se uređuje putem CMS-a.</p>
                 <p className="mt-4">KK Dinamo Zagreb posvećen je zaštiti vaše privatnosti...</p>
             </div>
          )}
      </section>
